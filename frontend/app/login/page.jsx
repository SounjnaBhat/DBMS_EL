...
import PageTransition from '@/app/PageTransition.jsx';
import {
  Leaf,
  Mail,
  Lock,
...
export default function LoginPage() {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative overflow-hidden font-sans text-gray-800 transition-colors duration-300">
        ...
        {/* Main Card */}
        <div className="bg-white w-full max-w-md p-8 rounded-3xl shadow-xl border border-gray-100 relative z-10 transition-colors duration-300">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full bg-gray- border border-gray-200  text-gray-800  rounded-xl py-3.5 pl-12 pr-12 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all placeholder:text-gray-400"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2 cursor-pointer group">
                <div className="relative flex items-center">
                  <input
                    type="checkbox"
                    className="peer h-5 w-5 cursor-pointer appearance-none rounded-md border border-gray-300  bg-white  transition-all checked:border-emerald-600 checked:bg-emerald-600"
                    checked={rememberMe}
              ...
              <Link href="/forgot" className="text-sm font-bold text-emerald-600 hover:underline transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-8 text-center pt-6 border-t border-gray-100">
            <p className="text-sm text-gray-500">
              ...
              <a href="/register" className="font-bold text-emerald-600 hover:underline transition-colors">
                Register now
              </a>
            </p>
          </div>
