...
const DonationCard = forwardRef(function DonationCard({ donation, index = 0 }, ref) {
      ...
      <div className="flex flex-1 flex-col p-6">
        <div className="mb-4">
          ...
          <div className="mt-2 flex items-center justify-between gap-2 text-sm text-slate-500">
            ...
            {!distance && donation.latitude && (
               <button onClick={getCurrentLocation} className="text-xs text-emerald-600 font-bold hover:underline">
                 Calc Dist
               </button>
            )}
          </div>
